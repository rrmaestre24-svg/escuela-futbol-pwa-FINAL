...
// El listado de jugadores en PDF se mudó a js/listado-pdf.js.
//
// Antes se dibujaba acá a mano con jsPDF y coordenadas en milímetros: una hoja
// apaisada con una tabla plana, sin fotos ni corte por categoría. La versión
// nueva arma HTML y deja que el navegador lo pagine, así se pueden incluir las
// fotos sin cargarlas todas en memoria y el diseño se cambia en CSS.

window.exportPlayersExcel = exportPlayersExcel;
// exportPlayersPDF NO se expone acá: la define y expone js/listado-pdf.js.
// Dejar la línea rompía la carga — la función ya no existe en este archivo y
// asignarla lanzaba ReferenceError en cada arranque.