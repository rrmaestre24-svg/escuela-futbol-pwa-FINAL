...
// ==================== SUPABASE CONFIG ====================
// Feature flag: false = Firebase (producción actual), true = Supabase (día del cutover)
// Para hacer el cutover: cambiar false → true aquí, eso es todo.
window.MODO_SUPABASE = false;
